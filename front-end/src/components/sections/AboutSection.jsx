          ...
          <div className="space-y-7">
            ...
            <div className="space-y-5 text-gray-700 text-lg leading-relaxed">
              <p className="animate-fade-in" style={{ animationDelay: "0.4s" }}>
                ...
                электронных замков для отелей, офисов, квартир и шкафчиков.
              </p>
            </div>

            <div
              className="mt-8 p-6 bg-gradient-to-br from-indigo-50 to-purple-50 rounded-2xl shadow-inner animate-fade-in"
